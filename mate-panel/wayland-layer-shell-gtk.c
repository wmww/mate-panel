...
gboolean wayland_has_initialized = FALSE;
...
gboolean
get_wayland_has_initialized ()
{
	return wayland_has_initialized;
}
...
wayland_shell_surface_new (GtkWindow *gtk_window)
{
	...
	// Make sure there isn't already a Wayland shell surface for this window'
...
void
wayland_shell_surface_global_init (void (*callback)(WaylandShellSurface *self))
{
	...
	wayland_shell_surface_popup_callback = callback;
